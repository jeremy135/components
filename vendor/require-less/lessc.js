...
tree.Dimension.prototype = {
    ...
    compare: function (other) {
        if (other instanceof tree.Dimension) {
            ...
            if (this.unit.isUndefinedOrNull() || other.unit.isUndefinedOrNull()) {
                a = this;
                b = other;
            } else {
                a = this.unify();
...
tree.Ruleset.prototype = {
    ...
    genCSS: function (env, output) {
        ...
        if (!output.isUndefinedOrNull() && !env.compress && this.firstRoot) {
            output.add('\n');
        }
    },
...
(function (tree) {
    ...
    tree.sourceMapOutput.prototype.isUndefinedOrNull = function() {
